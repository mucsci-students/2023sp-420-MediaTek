...
class View:
    ...
    def drawPuzzleUI(self, reqLetter, hexagonLetters):
                ...
                self.btn1 = tk.Button(self.canvas,text = hexagonLetters[0], background="white", font=('Helvetica 18 bold'), relief=FLAT, command = lambda: self.sendInput(hexagonLetters[0]),width=3, height=3)
                self.btn1.place(x=352.5, y=350)
                self.btn2 = tk.Button(self.canvas,text = hexagonLetters[1], background="white", font=('Helvetica 18 bold'), relief=FLAT, command = lambda: self.sendInput(hexagonLetters[1]),width=3, height=3)
                self.btn2.place(x=352.5, y=120)
                self.btn3 = tk.Button(self.canvas,text = hexagonLetters[2], background="white", font=('Helvetica 18 bold'), relief=FLAT, command = lambda: self.sendInput(hexagonLetters[2]),width=3, height=3)
                self.btn3.place(x=242, y=292)
                self.btn4 = tk.Button(self.canvas,text = hexagonLetters[3], background="white", font=('Helvetica 18 bold'), relief=FLAT, command = lambda: self.sendInput(hexagonLetters[3]),width=3, height=3)
                self.btn4.place(x=452, y=270)
                self.btn5 = tk.Button(self.canvas,text = hexagonLetters[4], background="white", font=('Helvetica 18 bold'), relief=FLAT, command = lambda: self.sendInput(hexagonLetters[4]),width=3, height=3)
                self.btn5.place(x=242, y=177)
                self.btn6 = tk.Button(self.canvas,text = hexagonLetters[5], background="white", font=('Helvetica 18 bold'), relief=FLAT, command = lambda: self.sendInput(hexagonLetters[5]),width=3, height=3)
                self.btn6.place(x=462.5, y=177)
                self.btn7 = tk.Button(self.canvas,text = reqLetter, font=('Helvetica 18 bold'), relief=FLAT,width=3, height=3)
                self.btn7.place(x=352.5, y=250)
            ...
            try:
                ...
                if filename:
                    ...
                    if os.path.exists(checkFile):
                        ...
                        #adds the rank
                        self.rankLabel = tk.Label(self.canvas, textvariable  = self.rank, font=('Helvetica 20 bold'), background='#F4F4F4')
                        self.rankLabel.place(x=60,y=490)
                        #get required letter
